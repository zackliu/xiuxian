...
import type { GameState, GameHistory, StoryBeat, TimelineEvent, CharacterSheet } from '@xiuxian/shared';
...
describe('API routes', () => {
  ...
  it('initializes game and allows story advancement and battle simulation', async () => {
    ...
    const advanceResponse = await request(app).post('/api/story/advance').send({ command: '凝心引灵泉' });
